        ...
        <div className="mt-10 space-y-8 text-white/80">
          <section>
            ...
            <p className="mt-2 leading-7">
              Dezenio Draft Design, Inc. (“we,” “us,” “our”) respects your privacy.
              This policy explains what information we collect, how we use it, and the
              choices you have when you visit our website or contact us.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5 leading-7">
              <li>
                <strong className="text-white">Contact information</strong> you provide (name,
                email, phone, address, project details).
              </li>
              <li>
                <strong className="text-white">Files and images</strong> you choose to send
                (drawings, inspiration photos, measurements, attachments).
              </li>
              <li>
                <strong className="text-white">Website usage data</strong> (basic analytics like
                pages viewed, approximate location, device/browser type). This may be collected by
                standard analytics tools or hosting providers.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5 leading-7">
              ...
              <li>To communicate about scheduling, design decisions, and project coordination.</li>
          ...
          <section>
            ...
            <p className="mt-2 leading-7">
              ...
              to operate our business, such as with:
            </p>
            <ul className="mt-2 list-disc space-y-2 pl-5 leading-7">
              <li>Service providers (hosting, email, forms, analytics) who help us run our website.</li>
              <li>Trade partners or vendors when necessary to coordinate materials or services.</li>
          ...
          <section>
            ...
            <p className="mt-2 leading-7">
              We retain information as long as needed to provide services, maintain records,
              and meet legal or business requirements. You can request deletion of certain
              information (subject to lawful recordkeeping needs).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 leading-7">
              Our site may use cookies or similar technologies for basic functionality and
          ...
          <section>
            ...
            <p className="mt-2 leading-7">
              We use reasonable safeguards to protect information. No method of transmission
